...
type MsgAttest struct {
	...
	VoteResult uint32 `protobuf:"varint,5,opt,name=vote_result,json=voteResult,proto3" json:"vote_result,omitempty"`
	// The validators participated in the attestation.
	VoteValidatorSet []uint64 `protobuf:"fixed64,6,rep,packed,name=vote_validator_set,json=voteValidatorSet,proto3" json:"vote_validator_set,omitempty"`
	// The aggregated BLS signature from the validators.
	VoteAggSignature []byte `protobuf:"bytes,7,opt,name=vote_agg_signature,json=voteAggSignature,proto3" json:"vote_agg_signature,omitempty"`
}
...
func (m *MsgAttest) GetObjectId() uint64 {
	if m != nil {
		return m.ObjectId
	}
	return 0
...
var fileDescriptor_516ed0ec90010e48 = []byte{
	...
	,
}
...
func (m *MsgAttest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ObjectId != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.ObjectId))
		i--
		dAtA[i] = 0x18
	}
	if m.ChallengeId != 0 {
