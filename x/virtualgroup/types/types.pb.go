...
type MigrationBucketSignDoc struct {
	...
	LocalVirtualGroupId     uint32 `protobuf:"varint,2,opt,name=local_virtual_group_id,json=localVirtualGroupId,proto3" json:"local_virtual_group_id,omitempty"`
...
func (m *MigrationBucketSignDoc) GetDstPrimarySpId() uint32 {
	if m != nil {
...
func (m *MigrationBucketSignDoc) GetLocalVirtualGroupId() uint32 {
	if m != nil {
...
func (m *MigrationBucketSignDoc) GetSrcGlobalVirtualGroupId() uint32 {
	if m != nil {
...
func (m *MigrationBucketSignDoc) GetDstGlobalVirtualGroupId() uint32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*MigrationBucketSignDoc)(nil), "greenfield.virtualgroup.MigrationBucketSignDoc")
}
...
var fileDescriptor_1fe6fc664532d0c3 = []byte{
	...
	,
}
...
func (m *MigrationBucketSignDoc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DstGlobalVirtualGroupId != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.DstGlobalVirtualGroupId))
		i--
		dAtA[i] = 0x20
	}
	if m.SrcGlobalVirtualGroupId != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.SrcGlobalVirtualGroupId))
		i--
		dAtA[i] = 0x18
	}
	...
	if m.DstPrimarySpId != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.DstPrimarySpId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MigrationBucketSignDoc) Size() (n int) {
	...
	_ = l
	if m.DstPrimarySpId != 0 {
		n += 1 + sovTypes(uint64(m.DstPrimarySpId))
	}
	if m.LocalVirtualGroupId != 0 {
		n += 1 + sovTypes(uint64(m.LocalVirtualGroupId))
	}
	if m.SrcGlobalVirtualGroupId != 0 {
		n += 1 + sovTypes(uint64(m.SrcGlobalVirtualGroupId))
	}
	if m.DstGlobalVirtualGroupId != 0 {
		n += 1 + sovTypes(uint64(m.DstGlobalVirtualGroupId))
	}
	l = m.BucketId.Size()
	n += 1 + l + sovTypes(uint64(l))
	return n
