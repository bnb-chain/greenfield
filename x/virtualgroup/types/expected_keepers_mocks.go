...
func (m *MockSpKeeper) IsStorageProviderExistAndInService(ctx types1.Context, addr types1.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockPaymentKeeper) UpdateStreamRecord(ctx types1.Context, streamRecord *types.StreamRecord, change *types.StreamRecordChange, autoSettle bool) error {
	m.ctrl.T.Helper()
