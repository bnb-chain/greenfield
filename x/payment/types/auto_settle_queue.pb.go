...
func (m *AutoSettleQueue) GetUser() string {
	if m != nil {
		return m.User
	}
	return ""
...
var fileDescriptor_838dd0c0192eb9ce = []byte{
	...
	0x60, 0x0e, 0x42, 0x08, 0x08, 0x09, 0x71, 0xb1, 0x94, 0x16, 0xa7, 0x16, 0x49, 0x30, 0x29, 0x30,
	...
	0xb1, 0x81, 0x5d, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xf5, 0xde, 0x6d, 0x25, 0xcc, 0x00,
	0x00, 0x00,
}
...
func (m *AutoSettleQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.User) > 0 {
		i -= len(m.User)
		copy(dAtA[i:], m.User)
		i = encodeVarintAutoSettleQueue(dAtA, i, uint64(len(m.User)))
		i--
		dAtA[i] = 0x12
	}
	if m.Timestamp != 0 {
