...
func (m *MockObjectInfo) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_a9d48407eec48c81 = []byte{
	...
	0x1f, 0x29, 0xe1, 0x68, 0x45, 0x51, 0x45, 0x00, 0x1b, 0xa0, 0x9a, 0xc4, 0xa8, 0xd6, 0xd6, 0x8c,
	0x9a, 0x57, 0x4d, 0x62, 0x08, 0x41, 0x4d, 0x24, 0x9f, 0x09, 0x5a, 0x55, 0x88, 0x3a, 0xc3, 0x3d,
	0xb0, 0x91, 0x88, 0x3e, 0x4f, 0x2e, 0x42, 0x49, 0xd0, 0x5a, 0x5b, 0x33, 0xd6, 0xbd, 0x3b, 0x00,
	0xb6, 0x41, 0x1d, 0x33, 0x2a, 0x09, 0x95, 0xfe, 0x2c, 0x23, 0xe8, 0x3f, 0x55, 0xbd, 0x0c, 0xc1,
	...
	0x00, 0xff, 0xff, 0xd2, 0x73, 0x69, 0x41, 0xf3, 0x03, 0x00, 0x00,
}
...
func (m *MockObjectInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintMockObjectInfo(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Owner) > 0 {
...
func (m *MockObjectInfo) Size() (n int) {
	...
	if m.Id != 0 {
		n += 1 + sovMockObjectInfo(uint64(m.Id))
	}
	if m.Size_ != 0 {
