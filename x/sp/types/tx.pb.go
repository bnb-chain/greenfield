...
type MsgCreateStorageProvider struct {
	...
	ReadPrice github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,9,opt,name=read_price,json=readPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"read_price"`
	...
	StorePrice github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,11,opt,name=store_price,json=storePrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"store_price"`
}
...
type MsgUpdateSpStoragePrice struct {
	...
	// read price, in 10 ^ -8 bnb per byte
	ReadPrice github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=read_price,json=readPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"read_price"`
	// free read quota, in byte
	FreeReadQuota uint64 `protobuf:"varint,4,opt,name=free_read_quota,json=freeReadQuota,proto3" json:"free_read_quota,omitempty"`
	// store price, in 10 ^ -8 bnb per charge byte
	StorePrice github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=store_price,json=storePrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"store_price"`
}
...
var fileDescriptor_f630c2933caa1bce = []byte{
	...
	,
}
