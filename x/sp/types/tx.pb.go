...
type MsgCreateStorageProvider struct {
	...
	// seal_bls_key defines the bls pub key of the Storage provider for sealing object
	SealBlsKey string `protobuf:"bytes,13,opt,name=seal_bls_key,json=sealBlsKey,proto3" json:"seal_bls_key,omitempty"`
}
...
func (m *MsgCreateStorageProvider) GetSealBlsKey() string {
	if m != nil {
		return m.SealBlsKey
	}
	return ""
...
func (m *MsgEditStorageProvider) GetSealBlsKey() string {
	if m != nil {
		return m.SealBlsKey
	}
	return ""
...
var fileDescriptor_f630c2933caa1bce = []byte{
	...
	,
}
...
func (m *MsgCreateStorageProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SealBlsKey) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.SealBlsKey)))
		i--
		dAtA[i] = 0x6a
	}
	{
