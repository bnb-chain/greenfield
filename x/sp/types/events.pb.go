...
type EventEditStorageProvider struct {
	...
	// old_description is the description of the storage provider before edit
	OldDescription string `protobuf:"bytes,3,opt,name=old_description,json=oldDescription,proto3" json:"old_description,omitempty"`
	// new_description is the description of the storage provider after edit
...
func (m *EventEditStorageProvider) GetOldDescription() string {
	if m != nil {
		return m.OldDescription
	}
	return ""
}

func (m *EventEditStorageProvider) GetNewDescription() string {
	if m != nil {
...
var fileDescriptor_685cbfa50fdf0841 = []byte{
	...
	,
}
...
func (m *EventEditStorageProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NewDescription) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.NewDescription)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.OldDescription) > 0 {
		i -= len(m.OldDescription)
		copy(dAtA[i:], m.OldDescription)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.OldDescription)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *EventEditStorageProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OldDescription", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OldDescription = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
