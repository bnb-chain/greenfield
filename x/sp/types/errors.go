...
var (
	...
	ErrStorageProviderTestAddrExists       = errors.Register(ModuleName, 17, "StorageProvider already exist for this test address; must use new StorageProvider test address.")
