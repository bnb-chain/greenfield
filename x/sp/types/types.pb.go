...
type StorageProvider struct {
	...
	SealBlsKey []byte `protobuf:"bytes,11,opt,name=seal_bls_key,json=sealBlsKey,proto3" json:"seal_bls_key,omitempty"`
}
...
func (m *StorageProvider) GetSealBlsKey() []byte {
	if m != nil {
		return m.SealBlsKey
	}
	return nil
...
var fileDescriptor_7a9af9b5be8c2eeb = []byte{
	...
	,
}
...
func (m *StorageProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SealBlsKey) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SealBlsKey)))
		i--
		dAtA[i] = 0x5a
	}
	{
...
func (m *StorageProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.SealBlsKey = append(m.SealBlsKey[:0], dAtA[iNdEx:postIndex]...)
			if m.SealBlsKey == nil {
				m.SealBlsKey = []byte{}
			}
			iNdEx = postIndex
