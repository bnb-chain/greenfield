...
//	//balances := sdk.Coins{sdk.Coin{Denom: s.Denom, Amount: sdkmath.NewInt(1e18)}}
//	bankKeeper.GetAllBalances(ctx, s.accountKeeper.EXPECT().GetModuleAddress(gomock.Any())).Return(balances))
