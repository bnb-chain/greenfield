...
var (
	...
	pattern_Query_ListGroup_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"bnb-chain", "greenfield", "storage", "list_group", "group_owner"}, "", runtime.AssumeColonVerbOpt(false)))
