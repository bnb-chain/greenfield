...
var (
	...
	ErrSPAddressMismatch           = errors.Register(ModuleName, 1107, "sp address mismatch")
	...
	ErrNoSuchGroupMember           = errors.Register(ModuleName, 1110, "no such group member")
	ErrGroupMemberAlreadyExists    = errors.Register(ModuleName, 1111, "group member already exists")
	ErrGroupMemberNotExists        = errors.Register(ModuleName, 1112, "group member already exists")
	ErrNoSuchStorageProvider       = errors.Register(ModuleName, 1113, "no such storage provider")
	ErrSequenceUniqueConstraint    = errors.Register(ModuleName, 1114, "sequence already initialized")
	ErrStorageProviderNotInService = errors.Register(ModuleName, 1115, "storage provider not in service")
	ErrObjectNotInit               = errors.Register(ModuleName, 1116, "not a INIT object")
