...
type MsgCompleteMigrateBucket struct {
	...
	NewLvgToGvgMappings        []*LVGToGVGMapping `protobuf:"bytes,3,rep,name=new_lvg_to_gvg_mappings,json=newLvgToGvgMappings,proto3" json:"new_lvg_to_gvg_mappings,omitempty"`
...
func (m *MsgCompleteMigrateBucket) GetNewLvgToGvgMappings() []*LVGToGVGMapping {
	if m != nil {
		return m.NewLvgToGvgMappings
	}
	return nil
}
...
var fileDescriptor_ddb71b028305a3cc = []byte{
	...
	,
}
...
func (m *MsgCompleteMigrateBucket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NewLvgToGvgMappings) > 0 {
		for iNdEx := len(m.NewLvgToGvgMappings) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NewLvgToGvgMappings[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgCompleteMigrateBucket) Size() (n int) {
	...
	if len(m.NewLvgToGvgMappings) > 0 {
		for _, e := range m.NewLvgToGvgMappings {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgCompleteMigrateBucket) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewLvgToGvgMappings", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewLvgToGvgMappings = append(m.NewLvgToGvgMappings, &LVGToGVGMapping{})
			if err := m.NewLvgToGvgMappings[len(m.NewLvgToGvgMappings)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
