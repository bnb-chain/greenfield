...
type BucketInfo struct {
	...
	PriceTime int64 `protobuf:"varint,10,opt,name=price_time,json=priceTime,proto3" json:"price_time,omitempty"`
	// outFlowsInUSD s
	OutFlowsInUSD []OutFlowInUSD `protobuf:"bytes,11,rep,name=outFlowsInUSD,proto3" json:"outFlowsInUSD"`
}
...
func (m *BucketInfo) GetPriceTime() int64 {
	if m != nil {
		return m.PriceTime
	}
	return 0
...
func (m *BucketInfo) GetOutFlowsInUSD() []OutFlowInUSD {
	if m != nil {
...
var fileDescriptor_bf95fa2efdc74d97 = []byte{
	...
	,
}
