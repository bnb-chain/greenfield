...
type EventCreateBucket struct {
	...
	ReadQuota uint64 `protobuf:"varint,7,opt,name=read_quota,json=readQuota,proto3" json:"read_quota,omitempty"`
...
type EventUpdateBucketInfo struct {
	...
	ReadQuotaBefore uint64 `protobuf:"varint,4,opt,name=read_quota_before,json=readQuotaBefore,proto3" json:"read_quota_before,omitempty"`
	// read_quota_after define the read quota after updated
	ReadQuotaAfter uint64 `protobuf:"varint,5,opt,name=read_quota_after,json=readQuotaAfter,proto3" json:"read_quota_after,omitempty"`
...
var fileDescriptor_946dcba4f763ddc4 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadQuotaBefore |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadQuotaAfter |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
