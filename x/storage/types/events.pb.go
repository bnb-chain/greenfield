...
type EventCreateBucket struct {
	...
	Status BucketStatus `protobuf:"varint,7,opt,name=status,proto3,enum=bnbchain.greenfield.storage.BucketStatus" json:"status,omitempty"`
	...
	PrimarySpAddress string `protobuf:"bytes,10,opt,name=primary_sp_address,json=primarySpAddress,proto3" json:"primary_sp_address,omitempty"`
}
...
type EventDiscontinueBucket struct {
	...
	// the block height after which the sp can safely delete it
	DeleteAt uint64 `protobuf:"varint,3,opt,name=delete_at,json=deleteAt,proto3" json:"delete_at,omitempty"`
}
...
func (m *EventDiscontinueBucket) GetDeleteAt() uint64 {
	if m != nil {
		return m.DeleteAt
	}
	return 0
...
type EventDiscontinueObject struct {
	...
	// the block height after which the sp can safely delete it
	DeleteAt uint64 `protobuf:"varint,4,opt,name=delete_at,json=deleteAt,proto3" json:"delete_at,omitempty"`
}
...
func (m *EventDiscontinueObject) GetDeleteAt() uint64 {
	if m != nil {
		return m.DeleteAt
	}
	return 0
...
var fileDescriptor_946dcba4f763ddc4 = []byte{
	...
	,
}
