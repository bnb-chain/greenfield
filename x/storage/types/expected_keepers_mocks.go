...
func (m *MockVirtualGroupKeeper) BindingObjectToGVG(ctx types3.Context, bucketID math.Uint, primarySPID, gvgFamilyID, gvgID uint32, payloadSize uint64) (*types2.LocalVirtualGroup, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BindingObjectToGVG", ctx, bucketID, primarySPID, gvgFamilyID, gvgID, payloadSize)
...
func (mr *MockVirtualGroupKeeperMockRecorder) BindingObjectToGVG(ctx, bucketID, primarySPID, gvgFamilyID, gvgID, payloadSize interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BindingObjectToGVG", reflect.TypeOf((*MockVirtualGroupKeeper)(nil).BindingObjectToGVG), ctx, bucketID, primarySPID, gvgFamilyID, gvgID, payloadSize)
}
...
func (m *MockVirtualGroupKeeper) UnBindingObjectFromLVG(ctx types3.Context, bucketID math.Uint, primarySPID, lvgID uint32, payloadSize uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnBindingObjectFromLVG", ctx, bucketID, primarySPID, lvgID, payloadSize)
	ret0, _ := ret[0].(error)
	return ret0
}

// UnBindingObjectFromLVG indicates an expected call of UnBindingObjectFromLVG.
func (mr *MockVirtualGroupKeeperMockRecorder) UnBindingObjectFromLVG(ctx, bucketID, primarySPID, lvgID, payloadSize interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnBindingObjectFromLVG", reflect.TypeOf((*MockVirtualGroupKeeper)(nil).UnBindingObjectFromLVG), ctx, bucketID, primarySPID, lvgID, payloadSize)
}
