...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/j75689/greenfield-cosmos-sdk v0.0.0-20230706002916-a43218b7a782 //github.com/bnb-chain/greenfield-cosmos-sdk v0.2.3-alpha.1
