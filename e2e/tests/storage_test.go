...
func (s *StorageTestSuite) TestDiscontinueObject_Normal() {
	...
	txRes := s.SendTxBlock(sp1.GcKey, msgDiscontinueObject)
	...
	s.SendTxBlock(sp2.GcKey, msgDiscontinueObject2)
...
func (s *StorageTestSuite) TestDiscontinueBucket_Normal() {
	...
	txRes := s.SendTxBlock(sp1.GcKey, msgDiscontinueBucket)
	...
	s.SendTxBlock(sp2.GcKey, msgDiscontinueBucket2)
